...
def initiateAssistant(audio):
    ...
    if 'set' and 'mood' in audio:
        webbrowser.open('https://www.youtube.com/watch?v=8j2gF-hq5C0', new = 0)
    
    elif 'tell' and 'joke' in audio:
    ...
    elif 'shut down' and 'avatar' or 'shutdown' and 'avatar' in audio or 'self destruct' and 'avatar' in audio:
        print(audio)
...
response('Build version 1.10_Avatar')
while True:
    initiator()
